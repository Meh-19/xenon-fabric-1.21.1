...
public class DampMossVineEndBlock extends AbstractPlantBlock {

    protected static final VoxelShape SHAPE =
            Block.createCuboidShape(1, 0, 1, 15, 16, 15);

    public DampMossVineEndBlock(Settings settings) {
        super(settings, Direction.DOWN, SHAPE, false);
    }

    @Override
    protected AbstractPlantStemBlock getStem() {
        return (AbstractPlantStemBlock) ModBlocks.DAMP_MOSS_HANG;
    }
    ...
    public BlockState getPlacementState(ItemPlacementContext context) {
        ...
        if (world.getBlockState(pos.up()).isOf(this)) {
            world.setBlockState(pos.up(), ModBlocks.DAMP_MOSS_HANG.getDefaultState());
        }
    ...
    public boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        ...
        return above.isOf(ModBlocks.DAMP_MOSS_HANG)
                || above.isOf(this)
    ...
    public void onStateReplaced(
        ...
        while (true) {
            ...
            if (scanState.isOf(ModBlocks.DAMP_MOSS_HANG)
                    || scanState.isOf(this)) {
        ...
        if (world.getBlockState(above).isOf(ModBlocks.DAMP_MOSS_HANG)) {
            world.setBlockState(
                    above,
    ...
    public void scheduledTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        ...
        if (world.isAir(below)) {
            ...
            world.setBlockState(pos, ModBlocks.DAMP_MOSS_HANG.getDefaultState());
        }
    }
