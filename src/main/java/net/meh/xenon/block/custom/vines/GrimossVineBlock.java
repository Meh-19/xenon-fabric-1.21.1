...
public class GrimossVineBlock extends AbstractPlantStemBlock {

    protected static final VoxelShape SHAPE =
            Block.createCuboidShape(1, 0, 1, 15, 16, 15);

    public GrimossVineBlock(Settings settings) {
        super(settings, Direction.DOWN, SHAPE, false, 0.11F);
    }

    @Override
    protected AbstractPlantBlock getPlant() {
        return (AbstractPlantBlock) ModBlocks.GRIMOSS_HANG_BOTTOM;
    }
    ...
    public boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        ...
        return above.isOf(this)
                || above.isOf(ModBlocks.GRIMOSS_HANG_BOTTOM)
    ...
    public void onStateReplaced(
        ...
        while (true) {
            ...
            if (scanState.isOf(this) || scanState.isOf(ModBlocks.GRIMOSS_HANG_BOTTOM)) {
        ...
        if (world.getBlockState(above).isOf(this)) {
            world.setBlockState(
                    above,
                    ModBlocks.GRIMOSS_HANG_BOTTOM.getDefaultState(),
                    Block.NOTIFY_ALL
            );
        }
    ...
    public void scheduledTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        ...
        if (world.isAir(below)) {
            world.setBlockState(below, ModBlocks.GRIMOSS_HANG_BOTTOM.getDefaultState());
        }
    }
