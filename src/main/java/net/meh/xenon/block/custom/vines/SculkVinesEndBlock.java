...
public class SculkVinesEndBlock extends AbstractPlantBlock {

    protected static final VoxelShape SHAPE =
            Block.createCuboidShape(1, 0, 1, 15, 16, 15);

    public SculkVinesEndBlock(Settings settings) {
        super(settings, Direction.DOWN, SHAPE, false);
    }

    @Override
    protected AbstractPlantStemBlock getStem() {
        return (AbstractPlantStemBlock) ModBlocks.SCULK_VINES;
    }
    ...
    public BlockState getPlacementState(ItemPlacementContext context) {
        ...
        if (world.getBlockState(pos.up()).isOf(this)) {
            world.setBlockState(pos.up(), ModBlocks.SCULK_VINES.getDefaultState());
        }
    ...
    public boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        ...
        return above.isOf(ModBlocks.SCULK_VINES)
                || above.isOf(this)
    ...
    public void onStateReplaced(
        ...
        while (true) {
            ...
            if (scanState.isOf(ModBlocks.SCULK_VINES)
                    || scanState.isOf(this)) {
        ...
        if (world.getBlockState(above).isOf(ModBlocks.SCULK_VINES)) {
            world.setBlockState(
                    above,
    ...
    public void scheduledTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        ...
        if (world.isAir(below)) {
            ...
            world.setBlockState(pos, ModBlocks.SCULK_VINES.getDefaultState());
        }
    }
