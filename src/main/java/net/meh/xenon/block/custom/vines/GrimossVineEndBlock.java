...
public class GrimossVineEndBlock extends AbstractPlantBlock {

    protected static final VoxelShape SHAPE =
            Block.createCuboidShape(1, 0, 1, 15, 16, 15);

    public GrimossVineEndBlock(Settings settings) {
        super(settings, Direction.DOWN, SHAPE, false);
    }

    @Override
    protected AbstractPlantStemBlock getStem() {
        return (AbstractPlantStemBlock) ModBlocks.GRIMOSS_HANG;
    }
    ...
    public BlockState getPlacementState(ItemPlacementContext context) {
        ...
        if (world.getBlockState(pos.up()).isOf(this)) {
            world.setBlockState(pos.up(), ModBlocks.GRIMOSS_HANG.getDefaultState());
        }
    ...
    public boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        ...
        return above.isOf(ModBlocks.GRIMOSS_HANG)
                || above.isOf(this)
    ...
    public void onStateReplaced(
        ...
        if (newState.isOf(ModBlocks.GRIMOSS_HANG)
                || newState.isOf(ModBlocks.GRIMOSS_HANG_BOTTOM)) {
            return;
        }
        ...
        while (true) {
            ...
            if (scanState.isOf(ModBlocks.GRIMOSS_HANG)
                    || scanState.isOf(this)) {
        ...
        if (world.getBlockState(above).isOf(ModBlocks.GRIMOSS_HANG)) {
            world.setBlockState(
                    above,
    ...
    public void scheduledTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        ...
        if (world.isAir(below)) {
            ...
            world.setBlockState(pos, ModBlocks.GRIMOSS_HANG.getDefaultState());
        }
    }
