...
public class ModBlocks {
    ...
    private static Identifier id(String name) {
        return Identifier.of("xenon", name);
    }
    ...
    private static Item registerBlockItem(String name, Block block) {
        return Registry.register(
                Registries.ITEM,
                id(name),
                new ModBlockItem(block, new Item.Settings())
        );
    }
    ...
    public static final Block PLATINUM_BLOCK = registerBlock("platinum_block",
            new Block(BlockBuilders.metalBlock()));
    ...
    public static final Block PLATINUM_PILLAR = registerBlock("platinum_pillar",
            new PillarBlock(BlockBuilders.metalBlock()));

    public static final Block PLATINUM_ORE = registerBlock("platinum_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(3, 7),BlockBuilders.ore()));

    public static final Block DEEPSLATE_PLATINUM_ORE = registerBlock("deepslate_platinum_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(3, 7),BlockBuilders.deepslateOre()));
    ...
    public static final Block MAPLE_LOG = registerBlock("maple_log",
            new PillarBlock(BlockBuilders.log()));
    ...
    public static final Block MAPLE_PLANKS = registerBlock("maple_planks",
            new Block(BlockBuilders.planks()));
    ...
    public static final Block BLEAK_STAIRS = registerBlock(
            "bleak_stairs",
            new StairsBlock(ModBlocks.BLEAK_PLANKS.getDefaultState(), BlockBuilders.oakStairs()));
    ...
    public static final Block FIR_STAIRS = registerBlock("fir_stairs",
            new StairsBlock(ModBlocks.FIR_PLANKS.getDefaultState(), BlockBuilders.oakStairs()));
    ...
    public static final Block PALM_STAIRS = registerBlock("palm_stairs",
            new StairsBlock(ModBlocks.PALM_PLANKS.getDefaultState(), BlockBuilders.oakStairs()));
    ...
    public static final Block BAYOU_STAIRS = registerBlock("bayou_stairs",
            new StairsBlock(ModBlocks.BAYOU_PLANKS.getDefaultState(), BlockBuilders.oakStairs()));
    ...
    public static final Block WISTERIA_STAIRS = registerBlock("wisteria_stairs",
            new StairsBlock(ModBlocks.WISTERIA_PLANKS.getDefaultState(), BlockBuilders.oakStairs()));
    ...
    public static final Block BAOBAB_STAIRS = registerBlock("baobab_stairs",
            new StairsBlock(ModBlocks.BAOBAB_PLANKS.getDefaultState(), BlockBuilders.oakStairs()));
    ...
    public static final Block FUNGAL_STAIRS = registerBlock("fungal_stairs",
            new StairsBlock(ModBlocks.FUNGAL_PLANKS.getDefaultState(), BlockBuilders.oakStairs()));
    ...
    public static final Block WHITE_FUNGAL_STAIRS = registerBlock("white_fungal_stairs",
            new StairsBlock(ModBlocks.WHITE_FUNGAL_PLANKS.getDefaultState(), BlockBuilders.planks()));

    public static final Block WHITE_FUNGAL_SLAB = registerBlock("white_fungal_slab",
            new SlabBlock(BlockBuilders.planks()));
    ...
    public static final Block LIGHT_GRAY_FUNGAL_STAIRS = registerBlock("light_gray_fungal_stairs",
            new StairsBlock(ModBlocks.LIGHT_GRAY_FUNGAL_PLANKS.getDefaultState(), BlockBuilders.planks()));
    ...
    public static final Block GRAY_FUNGAL_STAIRS = registerBlock("gray_fungal_stairs",
            new StairsBlock(ModBlocks.GRAY_FUNGAL_PLANKS.getDefaultState(), BlockBuilders.planks()));
    ...
    public static final Block BLACK_FUNGAL_STAIRS = registerBlock("black_fungal_stairs",
            new StairsBlock(ModBlocks.BLACK_FUNGAL_PLANKS.getDefaultState(), BlockBuilders.planks()));
    ...
    public static final Block BROWN_FUNGAL_STAIRS = registerBlock("brown_fungal_stairs",
            new StairsBlock(ModBlocks.BROWN_FUNGAL_PLANKS.getDefaultState(), BlockBuilders.planks()));
    ...
    public static final Block RED_FUNGAL_STAIRS = registerBlock("red_fungal_stairs",
            new StairsBlock(ModBlocks.RED_FUNGAL_PLANKS.getDefaultState(), BlockBuilders.planks()));
    ...
    public static final Block ORANGE_FUNGAL_STAIRS = registerBlock("orange_fungal_stairs",
            new StairsBlock(ModBlocks.ORANGE_FUNGAL_PLANKS.getDefaultState(), BlockBuilders.planks()));
    ...
    public static final Block YELLOW_FUNGAL_STAIRS = registerBlock("yellow_fungal_stairs",
            new StairsBlock(ModBlocks.YELLOW_FUNGAL_PLANKS.getDefaultState(), BlockBuilders.planks()));
    ...
    public static final Block LIME_FUNGAL_STAIRS = registerBlock("lime_fungal_stairs",
            new StairsBlock(ModBlocks.LIME_FUNGAL_PLANKS.getDefaultState(), BlockBuilders.planks()));
    ...
    public static final Block GREEN_FUNGAL_STAIRS = registerBlock("green_fungal_stairs",
            new StairsBlock(ModBlocks.GREEN_FUNGAL_PLANKS.getDefaultState(), BlockBuilders.planks()));
    ...
    public static final Block CYAN_FUNGAL_STAIRS = registerBlock("cyan_fungal_stairs",
            new StairsBlock(ModBlocks.CYAN_FUNGAL_PLANKS.getDefaultState(), BlockBuilders.planks()));
    ...
    public static final Block LIGHT_BLUE_FUNGAL_STAIRS = registerBlock("light_blue_fungal_stairs",
            new StairsBlock(ModBlocks.LIGHT_BLUE_FUNGAL_PLANKS.getDefaultState(), BlockBuilders.planks()));
    ...
    public static final Block BLUE_FUNGAL_STAIRS = registerBlock("blue_fungal_stairs",
            new StairsBlock(ModBlocks.BLUE_FUNGAL_PLANKS.getDefaultState(), BlockBuilders.planks()));
    ...
    public static final Block PURPLE_FUNGAL_STAIRS = registerBlock("purple_fungal_stairs",
            new StairsBlock(ModBlocks.PURPLE_FUNGAL_PLANKS.getDefaultState(), BlockBuilders.planks()));
    ...
    public static final Block MAGENTA_FUNGAL_STAIRS = registerBlock("magenta_fungal_stairs",
            new StairsBlock(ModBlocks.MAGENTA_FUNGAL_PLANKS.getDefaultState(), BlockBuilders.planks()));
    ...
    public static final Block PINK_FUNGAL_STAIRS = registerBlock("pink_fungal_stairs",
            new StairsBlock(ModBlocks.PINK_FUNGAL_PLANKS.getDefaultState(), BlockBuilders.planks()));
    ...
    public static final Block CHISELED_MUD = registerBlock("chiseled_mud",
            new Block(BlockBuilders.stoneBlock()));
    ...
    public static final Block CRIMSON_SHROOM_LANTERN = registerBlock("crimson_shroom_lantern",
            new Block(BlockBuilders.shroomLantern()));
    ...
    public static final Block FUNGAL_PAPER_LANTERN = registerBlock("fungal_paper_lantern",
            new Block(BlockBuilders.fungalPaperLantern()));
    ...
    public static final Block DIAMOND_BRICK = registerBlock("diamond_brick",
            new Block(BlockBuilders.mineralBrick()));

    public static final Block DIAMOND_PILLAR = registerBlock("diamond_pillar",
            new PillarBlock(BlockBuilders.mineralBrick()));
    ...
    public static final Block BLIGHTED_SHROOMLIGHT = registerBlock("blighted_shroomlight",
            new Block(BlockBuilders.shroomlight()));

    public static final Block LIMESTONE = registerBlock("limestone",
            new Block(BlockBuilders.stoneBlock()));

    public static final Block LIMESTONE_STAIRS = registerBlock(
            "limestone_stairs",
            new StairsBlock(ModBlocks.LIMESTONE.getDefaultState(), BlockBuilders.stoneBlock()));

    public static final Block LIMESTONE_SLAB = registerBlock("limestone_slab",
            new SlabBlock(BlockBuilders.stoneBlock()));

    public static final Block LIMESTONE_WALL = registerBlock("limestone_wall",
            new WallBlock(BlockBuilders.stoneBlock()));
    ...
    public static final Block LIMESTONE_BRICKS_STAIRS = registerBlock("limestone_bricks_stairs",
            new StairsBlock(ModBlocks.LIMESTONE_BRICKS.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block POLISHED_LIMESTONE_STAIRS = registerBlock("polished_limestone_stairs",
            new StairsBlock(ModBlocks.POLISHED_LIMESTONE.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block SANDY_LIMESTONE_BRICKS_STAIRS = registerBlock("sandy_limestone_bricks_stairs",
            new StairsBlock(ModBlocks.SANDY_LIMESTONE_BRICKS.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block RHYOLITE_STAIRS = registerBlock("rhyolite_stairs",
            new StairsBlock(ModBlocks.RHYOLITE.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block MOSSY_RHYOLITE_STAIRS = registerBlock("mossy_rhyolite_stairs",
            new StairsBlock(ModBlocks.MOSSY_RHYOLITE.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block RHYOLITE_BRICKS_STAIRS = registerBlock("rhyolite_bricks_stairs",
            new StairsBlock(ModBlocks.RHYOLITE_BRICKS.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block CRACKED_RHYOLITE_BRICKS_STAIRS = registerBlock("cracked_rhyolite_bricks_stairs",
            new StairsBlock(ModBlocks.CRACKED_RHYOLITE_BRICKS.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block MOSSY_RHYOLITE_BRICKS_STAIRS = registerBlock("mossy_rhyolite_bricks_stairs",
            new StairsBlock(ModBlocks.MOSSY_RHYOLITE_BRICKS.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block GRIMROCK_STAIRS = registerBlock("grimrock_stairs",
            new StairsBlock(ModBlocks.GRIMROCK.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block COBBLED_GRIMROCK_STAIRS = registerBlock("cobbled_grimrock_stairs",
            new StairsBlock(ModBlocks.COBBLED_GRIMROCK.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block CRACKED_GRIMROCK_BRICKS_STAIRS = registerBlock("cracked_grimrock_bricks_stairs",
            new StairsBlock(ModBlocks.CRACKED_GRIMROCK_BRICKS.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block GRIMROCK_BRICKS_STAIRS = registerBlock("grimrock_bricks_stairs",
            new StairsBlock(ModBlocks.GRIMROCK_BRICKS.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block MOSSY_GRIMROCK_BRICKS_STAIRS = registerBlock("mossy_grimrock_bricks_stairs",
            new StairsBlock(ModBlocks.MOSSY_GRIMROCK_BRICKS.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block POLISHED_GRIMROCK_STAIRS = registerBlock("polished_grimrock_stairs",
            new StairsBlock(ModBlocks.POLISHED_GRIMROCK.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block MOSSY_PACKED_LOAM_BRICKS_STAIRS = registerBlock("mossy_packed_loam_bricks_stairs",
            new StairsBlock(ModBlocks.MOSSY_PACKED_LOAM_BRICKS.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block PACKED_LOAM_STAIRS = registerBlock("packed_loam_stairs",
            new StairsBlock(ModBlocks.PACKED_LOAM.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block PACKED_LOAM_BRICKS_STAIRS = registerBlock("packed_loam_bricks_stairs",
            new StairsBlock(ModBlocks.PACKED_LOAM_BRICKS.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block DRIED_SILT_STAIRS = registerBlock("dried_silt_stairs",
            new StairsBlock(ModBlocks.DRIED_SILT.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block POLISHED_SILT_STAIRS = registerBlock("polished_silt_stairs",
            new StairsBlock(ModBlocks.POLISHED_SILT.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block SILT_BRICKS_STAIRS = registerBlock("silt_bricks_stairs",
            new StairsBlock(ModBlocks.SILT_BRICKS.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block SLATE_STAIRS = registerBlock("slate_stairs",
            new StairsBlock(ModBlocks.SLATE.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block POLISHED_SLATE_STAIRS = registerBlock("polished_slate_stairs",
            new StairsBlock(ModBlocks.POLISHED_SLATE.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block SLATE_BRICKS_STAIRS = registerBlock("slate_bricks_stairs",
            new StairsBlock(ModBlocks.SLATE_BRICKS.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block STRATA_STAIRS = registerBlock("strata_stairs",
            new StairsBlock(ModBlocks.STRATA.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block POLISHED_STRATA_STAIRS = registerBlock("polished_strata_stairs",
            new StairsBlock(ModBlocks.POLISHED_STRATA.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block STRATA_BRICKS_STAIRS = registerBlock("strata_bricks_stairs",
            new StairsBlock(ModBlocks.STRATA_BRICKS.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block CUT_POLISHED_BASALT_STAIRS = registerBlock("cut_polished_basalt_stairs",
            new StairsBlock(ModBlocks.CUT_POLISHED_BASALT.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block POLISHED_BASALT_BRICKS_STAIRS = registerBlock("polished_basalt_bricks_stairs",
            new StairsBlock(ModBlocks.POLISHED_BASALT_BRICKS.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block POLISHED_BASALT_TILES_STAIRS = registerBlock("polished_basalt_tiles_stairs",
            new StairsBlock(ModBlocks.POLISHED_BASALT_TILES.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block GRAVESTONE_STAIRS = registerBlock("gravestone_stairs",
            new StairsBlock(ModBlocks.GRAVESTONE.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block GRAVESTONE_BRICKS_STAIRS = registerBlock("gravestone_bricks_stairs",
            new StairsBlock(ModBlocks.GRAVESTONE_BRICKS.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block POLISHED_GRAVESTONE_STAIRS = registerBlock("polished_gravestone_stairs",
            new StairsBlock(ModBlocks.POLISHED_GRAVESTONE.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block DRIPSTONE_BRICKS_STAIRS = registerBlock("dripstone_bricks_stairs",
            new StairsBlock(ModBlocks.DRIPSTONE_BRICKS.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block POLISHED_DRIPSTONE_STAIRS = registerBlock("polished_dripstone_stairs",
            new StairsBlock(ModBlocks.POLISHED_DRIPSTONE.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block TAINTED_NETHER_BRICKS_STAIRS = registerBlock("tainted_nether_bricks_stairs",
            new StairsBlock(ModBlocks.TAINTED_NETHER_BRICKS.getDefaultState(), BlockBuilders.netherBrick()));
    ...
    public static final Block POLISHED_SOULSAND_STAIRS = registerBlock("polished_soulsand_stairs",
            new StairsBlock(ModBlocks.POLISHED_SOULSAND.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block POSSESSED_CHISELED_SOUL_BRICKS = registerBlock("possessed_chiseled_soul_bricks",
            new Block(BlockBuilders.possessed()));
    ...
    public static final Block SOUL_BRICKS_STAIRS = registerBlock("soul_bricks_stairs",
            new StairsBlock(ModBlocks.SOUL_BRICKS.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block PACKED_SNOW_STAIRS = registerBlock("packed_snow_stairs",
            new StairsBlock(ModBlocks.PACKED_SNOW.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block SNOW_BRICKS_STAIRS = registerBlock("snow_bricks_stairs",
            new StairsBlock(ModBlocks.SNOW_BRICKS.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block PACKED_ICE_BRICKS_STAIRS = registerBlock("packed_ice_bricks_stairs",
            new StairsBlock(ModBlocks.PACKED_ICE_BRICKS.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block POLISHED_PACKED_ICE_STAIRS = registerBlock("polished_packed_ice_stairs",
            new StairsBlock(ModBlocks.POLISHED_PACKED_ICE.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block POLISHED_PRISMARINE_STAIRS = registerBlock("polished_prismarine_stairs",
            new StairsBlock(ModBlocks.POLISHED_PRISMARINE.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block PRISMARINE_PILLAR = registerBlock("prismarine_pillar",
            new PillarBlock(BlockBuilders.stoneBlock()));
    ...
    public static final Block PRISMARINE_TILES_STAIRS = registerBlock("prismarine_tiles_stairs",
            new StairsBlock(ModBlocks.PRISMARINE_TILES.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block POROUS_DOLOMITE = registerBlock("porous_dolomite",
            new PorousDolomiteBlock(BlockBuilders.stoneBlock()));


    public static final Block DOLOMITE_STAIRS = registerBlock("dolomite_stairs",
            new StairsBlock(ModBlocks.DOLOMITE.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block POLISHED_DOLOMITE_STAIRS = registerBlock("polished_dolomite_stairs",
            new StairsBlock(ModBlocks.POLISHED_DOLOMITE.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block DOLOMITE_BRICKS_STAIRS = registerBlock("dolomite_bricks_stairs",
            new StairsBlock(ModBlocks.DOLOMITE_BRICKS.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block BRITTLE_BONE_BLOCK = registerBlock("brittle_bone_block",
            new PillarBlock(BlockBuilders.bone()));
    ...
    public static final Block KYANITE_STAIRS = registerBlock("kyanite_stairs",
            new StairsBlock(ModBlocks.KYANITE.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block KYANITE_BRICKS_STAIRS = registerBlock("kyanite_bricks_stairs",
            new StairsBlock(ModBlocks.KYANITE_BRICKS.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block POLISHED_KYANITE_STAIRS = registerBlock("polished_kyanite_stairs",
            new StairsBlock(ModBlocks.POLISHED_KYANITE.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block SCORIA_BRICKS_STAIRS = registerBlock("scoria_bricks_stairs",
            new StairsBlock(ModBlocks.SCORIA_BRICKS.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block MOLTEN_SCORIA_BRICKS_STAIRS = registerBlock("molten_scoria_bricks_stairs",
            new StairsBlock(ModBlocks.MOLTEN_SCORIA_BRICKS.getDefaultState(), BlockBuilders.stoneBlock()));
    ...
    public static final Block TERRACOTTA_SHINGLES = registerBlock("terracotta_shingles",
            new Block(BlockBuilders.terracottaShingles()));
    ...
    public static final Block QUILTED_WOOL_WHITE = registerBlock("quilted_wool_white",
            new Block(BlockBuilders.quiltedWool()));
    ...
    public static final Block FRAMED_WOODEN_CRATE = registerBlock("framed_wooden_crate",
            new Block(BlockBuilders.crates()));
    ...
    public static final Block WHITE_CRYSTAL_LANTERN = registerBlock("white_crystal_lantern",
            new AmethystBlock(BlockBuilders.crystalLantern()));
    ...
    public static final Block PRISM_LANTERN = registerBlock("prism_lantern",
            new PrismLanternBlock(BlockBuilders.crystalBlock()));

    public static final Block SHOJI = registerBlock("shoji",
            new Block(BlockBuilders.shoji()));

    public static final Block SALVAGING_TABLE = registerBlock("salvaging_table",
            new Block(BlockBuilders.table()));
    //endregion\
    //region plants, if it works don't touch it
    public static final Block AMARYLLIS = registerBlock("amaryllis",
            new TallOnlyPlantBlock(BlockBuilders.plants()));
    ...
    public static final Block OCULUS_ORCHID = registerBlock("oculus_orchid",
            new ModFlowerBlock(StatusEffects.FIRE_RESISTANCE, 0.35F,BlockBuilders.plants()));

    public static final Block SMALL_LILY =
            Registry.register(Registries.BLOCK, Identifier.of("xenon", "small_lily"), new ModLilyPadBlock(BlockBuilders.smallLily()));

    public static final Block HIBISCUS = registerBlock("hibiscus",
            new ModFlowerBlock(StatusEffects.ABSORPTION, 0.35F,BlockBuilders.plants()));

    public static final Block TALL_BEACH_GRASS = registerBlock(
            "tall_beach_grass", new ModTallPlantBlock(BlockBuilders.plants()));

    public static final Block BEACH_GRASS = registerBlock(
            "beach_grass", new ModShortPlantBlock((BlockBuilders.plants()), () -> (TallPlantBlock) TALL_BEACH_GRASS));

    public static final Block TALL_BRAMBLE = registerBlock(
            "tall_bramble", new TallBrambleBlock(BlockBuilders.bramble()));

    public static final Block BRAMBLE = registerBlock(
            "bramble", new ShortBrambleBlock(BlockBuilders.bramble(), () -> (TallPlantBlock) TALL_BRAMBLE));

    public static final Block TALL_DRY_GRASS = registerBlock(
            "tall_dry_grass", new ModTallPlantBlock(BlockBuilders.plants()));

    public static final Block DRY_GRASS = registerBlock(
            "dry_grass", new ModShortPlantBlock(BlockBuilders.plants(), () -> (TallPlantBlock) TALL_DRY_GRASS));

    public static final Block TALL_DRY_BUSH = registerBlock(
            "tall_dry_bush", new ModTallPlantBlock(BlockBuilders.plants()));

    public static final Block DRY_BUSH = registerBlock(
            "dry_bush", new ModShortPlantBlock(BlockBuilders.plants(), () -> (TallPlantBlock) TALL_DRY_BUSH));


    public static final Block TALL_FROSTED_GRASS = registerBlock(
            "tall_frosted_grass", new ModTallPlantBlock(BlockBuilders.plants()));

    public static final Block FROSTED_GRASS = registerBlock(
            "frosted_grass", new ModShortPlantBlock(BlockBuilders.plants(), () -> (TallPlantBlock) TALL_FROSTED_GRASS));

    public static final Block TALL_GRIMWEED = registerBlock(
            "tall_grimweed", new ModTallPlantBlock(BlockBuilders.plants()));

    public static final Block GRIMWEED = registerBlock(
            "grimweed", new ModShortPlantBlock(BlockBuilders.plants(), () -> (TallPlantBlock) TALL_GRIMWEED));

    public static final Block TALL_PALE_GRIMWEED = registerBlock(
            "tall_pale_grimweed", new ModTallPlantBlock(BlockBuilders.plants()));

    public static final Block PALE_GRIMWEED = registerBlock(
            "pale_grimweed", new ModShortPlantBlock(BlockBuilders.plants(), () -> (TallPlantBlock) TALL_PALE_GRIMWEED));

    public static final Block TALL_HOGWEED = registerBlock(
            "tall_hogweed", new ModTallPlantBlock(BlockBuilders.plants()));

    public static final Block HOGWEED = registerBlock(
            "hogweed", new ModShortPlantBlock(BlockBuilders.plants(), () -> (TallPlantBlock) TALL_PALE_GRIMWEED));

    public static final Block TALL_ORANGE_MYCENA = registerBlock(
            "tall_orange_mycena", new ModTallPlantBlock(BlockBuilders.plants()));

    public static final Block ORANGE_MYCENA = registerBlock(
            "orange_mycena", new ModShortPlantBlock(BlockBuilders.plants(), () -> (TallPlantBlock) TALL_ORANGE_MYCENA));

    public static final Block TALL_SOUL_STALKS = registerBlock(
            "tall_soul_stalks", new ModTallPlantBlock(BlockBuilders.plants()));

    public static final Block SOUL_STALKS = registerBlock(
            "soul_stalks", new ModShortPlantBlock(BlockBuilders.plants(), () -> (TallPlantBlock) TALL_SOUL_STALKS));

    public static final Block CLOVER = registerBlock(
            "clover", new SmallDecorationBlock(BlockBuilders.plants()));

    public static final Block STICK = registerBlock(
            "stick", new PlacedStickBlock(BlockBuilders.stickPlaceable()));

    public static final Block SCULK_VINES =
            registerBlock("sculk_vines",
                    new SculkVinesBlock(BlockBuilders.vines()));

    public static final Block SCULK_VINES_END =
            registerBlock("sculk_vines_end",
                    new SculkVinesEndBlock(BlockBuilders.vines()));

    public static final Block WARPED_VEIL =
            registerBlock("warped_veil",
                    new WarpedVeilBlock(BlockBuilders.vines()));

    public static final Block WARPED_VEIL_BOTTOM =
            registerBlock("warped_veil_bottom",
                    new WarpedVeilEndBlock(BlockBuilders.vines()));

    public static final Block ASH = registerBlock("ash",
            new GroundCoverBlock(BlockBuilders.ash()));
